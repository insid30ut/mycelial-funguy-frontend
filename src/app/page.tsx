      ...
      <main className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 text-center">
          ...
          <p className="text-xl text-mfg-light/90 mb-10 max-w-3xl mx-auto">
            Your final stop for everything to do with mushroom cultivation. Take a look around and discover the secrets of mushroom cultivation along with some of my own stories becoming a hobbyist grower to working at a gourmet/medicinal mushroom farm!
          </p>
